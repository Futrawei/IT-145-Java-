...
public class Driver {
    ...
    public static void intakeNewMonkey(Scanner scanner) {
        ...
        do {
            ...
            for(String validBreed : Monkey.input_validation)
        ...
        System.out.println("Where was " + name + "'s acquired? (United States or Canada)");
        String acquisitionCountry = scanner.nextLine().trim();
        ...
        System.out.println("What is " + name + "'s service country? (United States or Canada)");
        String inServiceCountry = scanner.nextLine().trim();
    ...
    public static void reserveAnimal(Scanner scanner) {
        System.out.println("What type of animal will be needed?");
        System.out.println("(CHOOSE: dog or monkey)");
        String animalType = scanner.nextLine().trim();

        System.out.println("Where will the animal be serving?");
        System.out.println("(CHOOSE: United States or Canada)");
        String animalServiceCountry = scanner.nextLine().trim();

        // Go through all dogs
        // Reserves the first non-reserved, in-service dog in the country
        if(animalType.equalsIgnoreCase("dog"))
            // For loop stating that the dog is in service
            for(Dog dog : dogList)
                if(dog.getInServiceLocation().equalsIgnoreCase(animalServiceCountry)
                    ...
                    System.out.println(dog.getName() + " has been reserved in " + dog.getInServiceLocation());
                    return;
                }
        ...
        if(animalType.equalsIgnoreCase("monkey"))
            // For loop stating that the monkey is in service
            for(Monkey monkey : monkeyList)
                if(monkey.getInServiceLocation().equalsIgnoreCase(animalServiceCountry)
                    ...
                    System.out.println(monkey.getName() + " has been reserved in " + monkey.getInServiceLocation());
                    return;
                }
    ...
    public static void printAnimals(String outputType) {
        ...
        // and reserve status
        System.out.printf("%-3.15s\t| %-2.15s\t| %-1.15s\t| %s%n%n", "Name", "Status", "acquisitionCountry", "Reserved");
